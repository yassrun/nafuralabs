...
sektor chantiers : `AttachementLigne.posteCode` est une chaîne libre, sans lien vers l'arbre — la moitié « attachement » d'AC-5 n'a rien à filtrer côté serveur tant que l'attachement n'est pas rattaché aux lignes @sektor
