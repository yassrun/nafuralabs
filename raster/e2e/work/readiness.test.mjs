/**
 * Preuve Raster— preuve 4 : la readiness au grain du sous-lot.
...
test("preuve 4 — un blocked_by INTERNE n'empêche pas le sous-lot", () => {
...
test("preuve 4 — un blocked_by EXTERNE ouvert bloque le sous-lot", () => {
