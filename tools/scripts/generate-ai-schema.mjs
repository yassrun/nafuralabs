 ...
 *     --scan products/sektor-btp/backend/modules \
 *     --out products/sektor-btp/backend/app/src/main/resources/ai-schema.generated.json \
 *     --overlay products/sektor-btp/backend/app/src/main/resources/ai-schema.overlay.json
 *
...
const scanRoot = path.resolve(args.scan ?? 'products/sektor-btp/backend/modules');
const outFile = path.resolve(
  args.out ?? 'products/sektor-btp/backend/app/src/main/resources/ai-schema.generated.json'
);
