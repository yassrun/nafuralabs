...
- Fichiers crees ou modifies (chemins) :
  - `venue-catalog/backend/app/`
  - `venue-catalog/backend/modules/api/`
  - `venue-catalog/backend/modules/source-adapter/`
  - `venue-catalog/backend/modules/catalog-job/`
  - `venue-catalog/backend/modules/catalog-place/`
  - `venue-catalog/backend/modules/compliance/`
  - `venue-catalog/deploy/k8s/`
  - `venue-catalog/web/app/catalog/search/`
- Tests :
