...
const utilUrl = pathToFileURL(
  path.join(__dirname, '../app/applications/erp/pages/chantiers/utils/planning-gantt-pdf.util.ts'),
).href;
...
const fixturePath = path.join(
  __dirname,
  '../app/applications/erp/pages/chantiers/utils/fixtures/villa-hassan-gantt.txt',
);
