...
export function ProLoginScreen({
  ...
  navigate: (screen: ProScreen) => void
  ...
  return (
    <main className="screen-container reveal-up">
      <header className="screen-header">
        <h1>Connexion pro</h1>
        <p className="screen-subtitle">Back-office venue Layali</p>
      </header>
...
export function ProBookingsListScreen({
  ...
  session: ManagerSession
  navigate: (screen: ProScreen, id?: string) => void
}) {
...
export function ProNoAccessScreen({ navigate }: { navigate: (screen: ProScreen) => void }) {
  return (
    <main className="screen-container reveal-up">
      <header className="screen-header">
      ...
      <section className="detail-section">
        ...
        <button type="button" className="secondary-btn" onClick={() => navigate('pro-login')}>Retour a l accueil</button>
      </section>
    </main>
  )
}

export function ProAccessRequestScreen({ navigate }: { navigate: (screen: ProScreen) => void }) {
...
export function ProTenantSuspendedScreen({ navigate }: { navigate: (screen: ProScreen) => void }) {
  return (
    <main className="screen-container reveal-up">
      <header className="screen-header">
      ...
      <section className="detail-section">
        ...
        <button type="button" className="secondary-btn" onClick={() => navigate('pro-login')}>Retour</button>
      </section>
    </main>
  )
}
...
export function ProTicketsListScreen({ navigate }: { session: ManagerSession; navigate: (screen: ProScreen) => void }) {
...
export function ProReviewsScreen({ navigate }: { session: ManagerSession; navigate: (screen: ProScreen) => void }) {
