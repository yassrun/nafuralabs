...
import type { ReservationStock } from '@app/features/stock/models';
...
@Component({
  ...
  template: `
    <section class="page">
      ...
      <p class="foot">
        <a routerLink="/stock/mouvements/sorties">{{ 'inventory.reservations.footer.sortiesLink' | translate }}</a> {{ 'inventory.reservations.footer.sortiesText' | translate }}
      </p>
    </section>
  `,
  styles: [
...
export class ReservationsStockPage implements OnInit {
  ...
  readonly rows = signal<import('@app/features/stock/models').ReservationStock[]>([]);
