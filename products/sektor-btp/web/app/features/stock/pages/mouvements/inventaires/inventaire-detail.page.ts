...
import type { InventaireTx } from '@app/features/stock/models';
import { InventaireLinesEditorComponent } from '@app/features/stock/components/inventaire-lines-editor/inventaire-lines-editor.component';
  ...
  protected override async handleSave(event: DetailActionEvent<InventaireTx>): Promise<void> {
    ...
    try {
      ...
      if (this.mode() === 'create') {
        ...
        this.router.navigate(['/stock/mouvements/inventaires', saved.id], { replaceUrl: true });
