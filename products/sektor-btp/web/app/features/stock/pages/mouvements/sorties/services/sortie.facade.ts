...
import type { Article, InventoryTx, Location, MotifMouvement } from '@app/features/stock/models';
import { ArticleCatalogService } from '@app/features/stock/services/article-catalog.service';
import { InventoryLookupsService } from '@app/features/stock/services/inventory-lookups.service';
import { InventoryMovementApiService } from '@app/features/stock/services/inventory-movement-api.service';
import {
  loadMovementPage,
  sumLineTotals,
} from '@app/features/stock/services/movement-facade.util';
import type { ApiInventoryTxRow } from '@app/features/stock/services/inventory-tx.mapper';
import { MotifsApiService } from '@app/features/stock/services/motifs-api.service';
import { ReservationStockService } from '@app/features/stock/services/reservation-stock.service';
