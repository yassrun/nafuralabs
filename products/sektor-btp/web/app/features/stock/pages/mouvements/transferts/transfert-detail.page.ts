...
import { TransfertLinesEditorComponent } from '@app/features/stock/components/transfert-lines-editor/transfert-lines-editor.component';
  ...
  protected override async handleSave(event: DetailActionEvent<InventoryTx>): Promise<void> {
    ...
    try {
      ...
      if (this.mode() === 'create') {
        ...
        this.router.navigate(['/stock/mouvements/transferts', saved.id], { replaceUrl: true });
