...
import { LocationsApiService } from '@app/features/stock/pages/configuration/depots/services/location-api.service';
...
export class ReceptionListingPage extends ConfigDrivenListingPage<ReceptionListItem> implements OnInit {
  ...
  protected override async handleCustomAction(
    ...
    if (event.actionId === 'scan_bl') {
      this.router.navigate(['/stock/mouvements/receptions/new'], {
