...
import type { InventoryTx, InventoryTxLine } from '@app/features/stock/models';
import { RetourLinesEditorComponent } from '@app/features/stock/components/retour-lines-editor/retour-lines-editor.component';
  ...
  protected override async handleSave(event: DetailActionEvent<InventoryTx>): Promise<void> {
    ...
    try {
      ...
      if (this.mode() === 'create') {
        ...
        this.router.navigate(['/stock/mouvements/retours', saved.id], { replaceUrl: true });
