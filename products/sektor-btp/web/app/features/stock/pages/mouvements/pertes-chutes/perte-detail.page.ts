...
import { PerteLinesEditorComponent } from '@app/features/stock/components/perte-lines-editor/perte-lines-editor.component';
  ...
  protected override async handleSave(event: DetailActionEvent<InventoryTx>): Promise<void> {
    ...
    try {
      ...
      if (this.mode() === 'create') {
        ...
        this.router.navigate(['/stock/mouvements/pertes-chutes', saved.id], { replaceUrl: true });
