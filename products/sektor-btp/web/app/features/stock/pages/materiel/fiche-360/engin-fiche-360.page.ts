...
import { MaterielGmaoFacadeService } from '@app/features/stock/services/materiel-gmao-facade.service';
import {
  MaterielAffectationApiService,
  apiToAffectationChantier,
} from '@app/features/stock/services/materiel-affectation-api.service';
...
export class EnginFiche360Page {
  ...
  header(eng: CatalogueMateriel) {
    return {
      ...
      subtitle: eng.code,
      breadcrumbs: [
        { label: this.translate.instant('nav.stock'), route: '/stock/suivi/etat-stock' },
