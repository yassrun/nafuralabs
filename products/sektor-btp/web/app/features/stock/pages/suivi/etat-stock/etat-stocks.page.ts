...
import { LocationTypeBadgeComponent } from '@app/features/stock/components/location-type-badge';
import { QuantityStatusCellComponent } from '@app/features/stock/components/quantity-status-cell';
  ...
  readonly listingConfig: ListingPageConfig<EtatStockItem> = buildListingConfig<EtatStockItem>(
    {
      ...
      routes: {
        list: ['/stock/stock-levels'],
        create: ['/stock/stock-levels'],
        detail: (item) => ['/stock/stock-levels', item.id],
      },
