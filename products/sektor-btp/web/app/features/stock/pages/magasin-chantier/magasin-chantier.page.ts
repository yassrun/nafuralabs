...
} from '@app/features/stock/services/magasin-chantier-api.service';
import type { Location, StockBalance } from '@app/features/stock/models';
  ...
  template: `
    @if (location(); as loc) {
      <section class="page">
        ...
        <div class="actions">
          <a class="btn" [routerLink]="['/stock/mouvements/sorties']" [queryParams]="sortieQuery()">
            Bon de matières (sortie)
          </a>
          <a class="btn ghost" [routerLink]="['/stock/mouvements/transferts']">Transfert vers chantier</a>
        </div>
        <table>
          <thead>
            <tr>
