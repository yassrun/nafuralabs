...
import type { Chantier, ChantierStatus } from '@app/features/chantiers/models';
import { ChantierLotApiService } from '../services/chantier-lot-api.service';
import {
  CHANTIER_STATUS_KEYS,
  CHANTIER_TYPE_KEYS,
} from '@app/shell/i18n-labels';
import { ContratMarcheApiService } from '@app/features/marches/pages/contrats/services/contrat-marche-api.service';
import type { Marche } from '@app/features/marches/pages/models';
import {
  SituationGenerationService,
  type SituationDraftBrouillon,
} from '@app/features/marches/pages/services/situation-generation.service';
