...
export const CHANTIERS_ROUTES: Routes = [
  {
    ...
    pathMatch: 'full',
    loadComponent: () =>
      import('./pages/chantiers-listing/chantiers-listing.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/planning/chantiers-planning.page').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/avancements/avancements.routes').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/situations/situations.routes').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/attachements/attachement-saisie/attachement-saisie.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/attachements/attachement-listing/attachement-listing.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/journal/journal-chantier.page').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/sous-traitance/sous-traitance.routes').then(
  ...
  },
  {
    path: 'chantiers/new',
    loadComponent: () =>
      import('./pages/create/chantier-create.page').then((m) => m.ChantierCreatePage),
    data: { title: 'Nouveau chantier', breadcrumb: 'Création' },
  },
  {
    path: 'chantiers/:id/edit',
    loadComponent: () =>
      import('./pages/edit/chantier-edit.page').then((m) => m.ChantierEditPage),
    data: { title: 'Modifier chantier', breadcrumb: 'Modifier' },
  },
  {
    path: 'chantiers/:id',
    loadComponent: () =>
      import('./pages/chantier-detail/chantier-detail.page').then(
