...
export const PILOTAGE_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/marges-chantier/marges-chantier.page').then(m => m.MargesChantierPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/marge-consolidee/marge-consolidee.page').then(m => m.MargeConsolideePage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/cash-flow/cash-flow.page').then(m => m.CashFlowPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/pilotage-analyses/pages/rentabilite/rentabilite-analyses.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/pilotage-analyses/pages/financier/financier-analyses.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/pilotage-analyses/pages/stock/stock-analyses.page').then((m) => m.StockAnalysesPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/pilotage-analyses/pages/achats/achats-analyses.page').then((m) => m.AchatsAnalysesPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/pilotage-analyses/pages/rh/rh-analyses.page').then((m) => m.RhAnalysesPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/pilotage-analyses/pages/what-if/what-if-analyses.page').then((m) => m.WhatIfAnalysesPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/pilotage-analyses/pages/opex-capex/opex-capex-analyses.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/pilotage-analyses/pages/groupe/groupe-analyses.page').then((m) => m.GroupeAnalysesPage),
