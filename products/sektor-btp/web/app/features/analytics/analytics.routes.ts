...
export const ANALYTICS_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/tableau-chantiers/tableau-chantiers.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/tableau-achats/tableau-achats.page').then(
  ...
  },
  {
    path: 'analytics/rh',
    loadComponent: () =>
      import('./pages/tableau-rh/tableau-rh.page').then(
        (m) => m.TableauRhPage,
      ),
  ...
  },
  {
    path: 'analytics/hse',
    loadComponent: () =>
      import('./pages/tableau-hse/tableau-hse.page').then(
        (m) => m.TableauHsePage,
      ),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/tableau-stock/tableau-stock.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/tableau-financier/tableau-financier.page').then(
