...
import { PilotageAnalysesDataService } from '@app/features/pilotage-analyses/pages/services/pilotage-analyses-data.service';
        ...
        <section class="analytics-chart-card">
          ...
          <ol class="analytics-list">
            @for (a of s.topArticles; track a.code) {
              <li><a routerLink="/stock/catalogue/items">{{ a.code }}</a> — {{ a.name }} ({{ a.qty | number:'1.0-0' }})</li>
            } @empty {
