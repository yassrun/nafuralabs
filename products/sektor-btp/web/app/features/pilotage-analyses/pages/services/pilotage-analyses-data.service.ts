...
import type { BalanceLigne, BalanceTotaux } from '@app/features/finance/models';
import { BalanceApiService } from '@app/features/finance/services/balance-api.service';
import type { Chantier } from '@app/features/chantiers/models';
import { ChantierApiService } from '@app/features/chantiers/pages/services/chantier-api.service';
import { AnalyticsApiService } from '@app/features/analytics/pages/services/analytics-api.service';
import {
  DashboardKpiApiService,
  type DashboardAllKpis,
} from '@app/features/dashboard/pages/services/dashboard-kpi-api.service';

import {
  PilotageChantierMargesService,
  type PilotageChantierMargeRow,
} from '@app/features/pilotage/pages/services/pilotage-chantier-marges.service';
