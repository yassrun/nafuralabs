    ...
    <nf-page-shell scroll>
      ...
      @if (data.hydrated()) {
        ...
        <div class="kpi-strip" data-pilotage-loaded="true">
          <a class="kpi" routerLink="/stock/suivi/valorisation">
          ...
          <a class="kpi" routerLink="/stock/suivi/etat-stock">
          ...
          <a class="kpi" routerLink="/stock/magasin-chantier/ch-001">
          ...
          <a class="kpi" routerLink="/stock/suivi/stock-balances">
