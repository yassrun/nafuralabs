import type { Currency, CurrencyCreate, CurrencyUpdate } from '.././pages/configuration/currencies/models';
import type { ExchangeRate, ExchangeRateCreate, ExchangeRateUpdate } from '.././pages/configuration/exchange-rates/models';
