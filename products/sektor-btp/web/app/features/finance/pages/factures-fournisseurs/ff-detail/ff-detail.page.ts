...
import { SubmitApprovalButtonComponent } from '@app/features/approbations/pages/components/submit-approval-button/submit-approval-button.component';
import type { ComptaFournisseur } from '@app/features/finance/models';
import { ChartOfAccountApiService } from '@app/features/finance/services/chart-of-account-api.service';
import { FiscalSettingsService } from '@app/shell/fiscal-settings.service';
import { TvaAutoliquidationService } from '@app/features/finance/services/tva-autoliquidation.service';
import { FF_STATUS_KEYS } from '@app/shell/i18n-labels';
import type { MatchingReception } from '@app/features/achats/models';
import { MatchingService } from '@app/features/achats/services/matching.service';
import { FfApiService } from '@app/features/achats/pages/factures-fournisseur/services/ff-api.service';
import { partnerToComptaFournisseur } from '@app/features/achats/pages/factures-fournisseur/services/ff.mapper';
        ...
        @if (threeWay(); as tw) {
          <section class="match-card">
            ...
            <p class="match-card__meta">
              ...
              @if (tw.receptionId) {
                <a [routerLink]="['/stock/mouvements/receptions', tw.receptionId]">{{ tw.receptionNumero }}</a>
