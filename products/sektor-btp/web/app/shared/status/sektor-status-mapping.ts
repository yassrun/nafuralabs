import type { StatusMap } from '@platform/lib/anatomy/components/atoms/status-badge/status-mapping';

/** Sektor BTP entity status catalogs (provided into STATUS_MAPPING_CATALOG). */
export const SEKTOR_STATUS_MAPPING: Record<string, StatusMap> = {
  CHANTIER: {
