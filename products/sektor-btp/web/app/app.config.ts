...
import { ACTIVE_TRANSLATION_LAYERS } from '@app/config/i18n';
...
import { APP_SHELL_CONFIG } from '@app/config/shell.config';
...
import { ErpNotificationsService } from '@app/shell/erp-notifications.service';
import { ensurePublicHttpOrigin } from '@platform/core/config/public-web-origin';
import { ErpNotificationBellAdapter } from '@app/shell/erp-notification-bell.adapter';
import { ErpNotificationBellListComponent } from '@app/shell/erp-notification-bell-list.component';
