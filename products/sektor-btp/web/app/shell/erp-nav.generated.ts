        ...
        children: [
          {
            ...
            icon: 'download',
            route: '/stock/mouvements/receptions',
            order: 10,
          },
          {
            ...
            icon: 'upload',
            route: '/stock/mouvements/sorties',
            order: 15,
          },
          {
            ...
            icon: 'repeat',
            route: '/stock/mouvements/transferts',
            order: 20,
          },
          {
            ...
            icon: 'undo-2',
            route: '/stock/mouvements/retours',
            order: 40,
          },
          {
            ...
            icon: 'clipboard-list',
            route: '/stock/mouvements/inventaires',
            order: 50,
          },
          {
            ...
            icon: 'triangle-alert',
            route: '/stock/mouvements/pertes-chutes',
            order: 60,
          },
        ],
      },
      ...
      // Suivi & Valorisation
      {
        ...
        children: [
          ...
          },
          {
            ...
            icon: 'coins',
            route: '/stock/suivi/valorisation',
            order: 20,
          },
          {
        ...
        children: [
          {
            ...
            icon: 'package',
            route: '/stock/catalogue/articles',
            order: 10,
          },
          {
            ...
            icon: 'folder',
            route: '/stock/configuration/familles',
            order: 20,
          },
          {
            ...
            icon: 'tag',
            route: '/stock/configuration/types-articles',
            order: 30,
          },
          {
        ...
        children: [
          {
            ...
            icon: 'map-pin',
            route: '/stock/configuration/depots',
            order: 10,
          },
          {
            ...
            icon: 'list-ordered',
            route: '/stock/configuration/motifs',
            order: 20,
          },
          {
            ...
            icon: 'calculator',
            route: '/stock/configuration/costing-methods',
            order: 30,
          },
        ],
      },
