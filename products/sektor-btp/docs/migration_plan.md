...
- `backend/app` as a thin application shell with no business logic
...
- 40 Angular `*-api.service.ts` files exist under `products/sektor-btp/web/app/pages`
...
- pure HTTP default:
  - `web/app/pages/finance/configuration/currencies/services/currency-api.service.ts`
  - `web/app/pages/inventory/catalogue/items/services/item-api.service.ts`
