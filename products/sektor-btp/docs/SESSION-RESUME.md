...
- **Rebrand Nafura Sektor** : cobalt `#1B3FAE` + jaune `#F2D544`, Space Grotesk. Source : `app/styles/brand-sektor.scss`. Logos : `public/assets/branding/sektor-*.svg`.
