...
```bash
python -X utf8 products/sektor-btp/docs/extraction/gap-test/run_extractor.py
python -X utf8 products/sektor-btp/docs/extraction/gap-test/build_llm_gold.py
python -X utf8 products/sektor-btp/docs/extraction/gap-test/compare_gaps.py
```
