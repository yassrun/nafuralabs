...
|---|---|---|---|
| **L5** | Gel du prix + branchement `ResolutionPrixService` | L2 | ✅ done |
| **L6** | Front du chiffrage — sélecteur d'origine, 3 lignes, synthèse | L1 | ✅ done |
| **L7** | Conditionnement fournisseur + typage des références | L3 | ✅ done |
| **L8** | Avis d'exécution | L4 | ✅ done |

### Vague 3

| Lot | Titre | Dépend de | Status |
|---|---|---|---|
| **L9** | Rattrapage, création d'article allégée, `hors_referentiel` | L5 | ✅ done |
| **L10** | Ouvrage composite : récursion + garde anti-cycle | L2, **PR2** ✅ provisoire | ✅ done |
| **L11** | Comparateur fournisseurs + écran | L7 | ✅ done |

### Vague 4

| Lot | Titre | Dépend de | Status |
|---|---|---|---|
| **L12** | Bibliothèque : capitalisation + chargement du corpus | L10 | ✅ done |
| **L13** | Chaînage aval : devis, chantier, marché, budget | L1, L5 | ✅ done |

### Vague 5 — après **PR1 (clause CGU)**

| Lot | Titre | Dépend de | Status |
|---|---|---|---|
| **L14** | Module `catalogue` : entités, éditions, gouvernance, console | L11, L12, PR1 | ✅ done |
| **L15** | Rapprochement déterministe + `item_match` | L14 | ✅ done |

### Vague 6

| Lot | Titre | Dépend de | Status |
|---|---|---|---|
| **L16** | Intelligence : ports réels, LLM en dernier recours, enrichissement | L15 | ✅ done |
| **L16b** | Polish : adapter LLM Gemini + prix tenant 6 mois | L16 | ✅ done |
...
2. products/sektor-btp/docs/specs/epics/_archive/referentiel-catalogue-sektor/00-INDEX.md
3. products/sektor-btp/docs/specs/epics/_archive/referentiel-catalogue-sektor/01-modele-cible.md
4. products/sektor-btp/docs/specs/epics/_archive/referentiel-catalogue-sektor/02-phases.md (ta phase)
5. products/sektor-btp/docs/specs/epics/_archive/referentiel-catalogue-sektor/05-ux.md (si ton lot a du front)
...
**PR2 (codification)** — ✅ provisoire accepté
([`01-ADR-pr2-codification.md`](01-ADR-pr2-codification.md)). L10 débloqué ; révision expert
possible sans reset.
