...
> Source : audit UX/fonctionnel daté **2026-05-09** (`docs/audit_claude.md`) + analyse codebase.
> Périmètre : ERP BTP Maroc (`web/app/`) — 13 modules sidebar.
...
| `chantier-detail-placeholder.page.ts` est un placeholder | `app/pages/chantiers/detail/` | Nom + intent : ce n'est PAS la vraie fiche détail. À remplacer | F-01 → 02-chantiers-bugs |
