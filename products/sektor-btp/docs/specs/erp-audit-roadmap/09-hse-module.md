...
⚠️ **Note** : il existe déjà des pages stub dans `app/pages/hse/` (formations, incidents, inspections, non-conformites). Vérifier leur contenu et **les compléter** plutôt que recréer.
...
```
app/pages/hse/                                # base existante (~30%)
app/pages/hse/formations/                     # à compléter
app/pages/hse/incidents/                      # à compléter
app/pages/hse/inspections/                    # à compléter
app/pages/hse/non-conformites/                # à compléter
app/hse/hse.routes.ts                         # routing module
app/shell/erp-nav.generated.ts                # nav HSE
```
...
4. Wirer le routing dans `app/hse/hse.routes.ts`.
