...
```
app/pages/rh/paie/                            # paie existante
app/rh/models/                                # models paie
app/rh/mock/rh-mock.service.ts                # service paie mock
app/pages/finance/factures-fournisseurs/      # factures fourn (TVA + RAS)
app/ventes/models/index.ts                    # FactureClient
```
...
**Fichier** : `app/rh/paie/services/bareme-paie-2026.ts`
...
**Fichier** : `app/rh/paie/services/paie-engine.service.ts`
...
**Fichiers** :
- `app/finance/services/tva-engine.service.ts`
- `app/finance/services/retenue-source.service.ts`
- `app/finance/services/timbre-fiscal.service.ts`
- `app/finance/services/autoliquidation.service.ts`
