...
```
app/pages/ventes/                              # ventes existantes (peut être étendu)
app/pages/chantiers/situations/                # situations existantes (drillé par marché)
app/ventes/models/index.ts                     # FactureClient, OffreCommerciale, BC client
app/pages/finance/factures-fournisseurs/       # FF existant
...
**Fichier** : `app/marches/marches.routes.ts` (à créer)
