...
**Localisation** : `app/pages/chantiers/detail/chantier-detail-placeholder.page.ts:42-46`
...
**Mocks chantiers** : `app/chantiers/mock/seeds.ts` contient `SEED_CHANTIERS` avec 6 entrées `CH-2026-001..006`.
...
- **Audit source** : `docs/audit_claude.md`
