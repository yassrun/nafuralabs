...
```
app/pages/analytics/                          # tableau-* existants
app/shell/erp-nav.generated.ts                # nav approbations + pilotage
...
**Fichier à créer** : `app/pilotage/pilotage.routes.ts`
...
**Fichier à créer** : `app/approbations/approbations.routes.ts`
