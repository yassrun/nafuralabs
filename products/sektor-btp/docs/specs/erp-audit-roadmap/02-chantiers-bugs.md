...
```
app/pages/chantiers/detail/chantier-detail-placeholder.page.ts   # actuel = placeholder
app/pages/chantiers/chantiers-listing/chantiers-listing.page.ts  # créé S1, drill-down (click)="open(c)"
app/chantiers/chantiers.routes.ts                                 # routing module
app/chantiers/mock/chantiers-mock.service.ts (ligne 409)         # getChantierById(id)
app/chantiers/mock/seeds.ts                                       # SEED canonique
app/shell/erp-nav.generated.ts (lignes 91, 107)                   # nav ST + Documents
```
...
**Fichier à créer** : `app/pages/chantiers/chantier-detail/chantier-detail.page.ts`
...
**Pattern à suivre** : voir `app/pages/chantiers/budget/budget-chantier-detail/budget-chantier-detail.page.ts` pour le pattern multi-onglets.
...
```bash
grep -rln "chantierCode\|chantier.code" app/pages/ | xargs grep -L "routerLink.*chantiers\|navigate.*chantiers"
```

Cibles probables :
- `app/pages/chantiers/avancements/avancements-listing/`
- `app/pages/chantiers/situations/situation-listing/`
- `app/pages/achats/demandes/demande-listing/` (colonne chantier)
- `app/pages/inventory/materiel/affectations/`
...
```
app/pages/chantiers/sous-traitance/
...
**Fichier** : `app/pages/chantiers/planning/chantiers-planning.page.ts`
