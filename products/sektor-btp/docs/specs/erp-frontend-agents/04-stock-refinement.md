...
- Lire en intégralité `web/app/pages/inventory/mouvements/receptions/AGENT_RECEPTION_UX_SOCLE_BRIEF.md`, `AGENT_UX_FIXES.md`, `AGENT_ACTION_BAR_SPEC.md` — leurs principes restent normatifs.
