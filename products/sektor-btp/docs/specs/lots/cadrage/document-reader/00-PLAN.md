...
# Document reader — moteur de lecture unifié
...
> Nom de marque à choisir plus tard — le slug technique, lui, ne bouge plus.
...
| 4 | **Bascule vague 1** | Forme par forme — `liste` (5 écrans) puis `arbre` (lots de chantier, bordereau) ; LLM en repli. Côté écrans : [`ecrans-lecture-documents`](../ecrans-lecture-documents/00-PLAN.md) (ERP-67) | 3 |
...
|------|-----|
| Feature | ERP-53 |
| Écrans (demande) | ERP-67 — `ecrans-lecture-documents` |
| Spec / ADR | ce dossier |
