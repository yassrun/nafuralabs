...
> **Source de vérité** : `docs/specs/erp-audit-round-2-roadmap/00-PROGRESS.md`.
> **Audit d'origine** : `docs/specs/ROUNDéAUDIT/AUDIT_round_2`.
...
```text
Règles projet :
- Workspace : `products/sektor-btp/web/` (Angular ERP BTP Maroc).
- Lire AVANT de coder : `docs/specs/erp-audit-roadmap/00-PROGRESS.md` (Round 1, ~68% implémenté) pour identifier ce qui existe déjà → enrichir, pas réécrire.
- Après chaque tâche : `ng build` sans erreur + tests ciblés + `npm run lint:no-dollar`.
- Mettre à jour `docs/specs/erp-audit-round-2-roadmap/00-PROGRESS.md` (statut + colonne évidence + date + agent).
- Conventions :
...
Spec : `docs/specs/erp-audit-round-2-roadmap/01-dashboard.md`.
...
Fichiers à toucher :
- `app/pages/dashboard/dashboard.page.{ts,html}`
- `app/pages/dashboard/widgets/` (créer kpi-tile, ca-cumul-chart, sparkline, top-alertes, alerts-panel)
- `app/pages/dashboard/dashboard-layout.service.ts` (nouveau)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/02-chantiers.md`.
...
Fichiers à toucher :
- `app/pages/chantiers/detail/chantier-detail.page.ts` (fix + 12 onglets)
- `app/pages/chantiers/create/` (nouveau wizard)
- `app/pages/chantiers/map/` (nouveau)
- `app/pages/chantiers/photos/` (nouveau)
- `app/pages/chantiers/plans/` (nouveau)
- `app/pages/chantiers/risques/` (nouveau)
- `app/chantiers/chantiers.routes.ts`
...
Spec : `docs/specs/erp-audit-round-2-roadmap/03-achats.md`.
...
Fichiers à toucher :
- `app/pages/achats/` (étendre)
- `app/pages/inventory/mouvements/receptions/` (lien BC)
- `app/pages/finance/factures-fournisseurs/` (onglet matching)
- `app/achats/services/` (matching, scoring, attestations)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/04-stock.md`.
...
Fichiers à toucher :
- `app/pages/inventory/` (étendre)
- `app/inventory/services/` (étendre `inventory-tx.facade.ts`, `stock-budget-sync.service.ts`)
- `app/pages/inventory/magasin-chantier/` (nouveau)
- `app/pages/inventory/reservations/` (nouveau)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/05-materiel.md`.
...
Fichiers à créer :
- `app/pages/materiel/maintenance/` (plans, ot, historique)
- `app/pages/materiel/carburant/` (carnets, pleins, consommations)
- `app/pages/materiel/fiche-360/`
- `app/pages/materiel/locations/` (étendre stub)
- `app/pages/materiel/planning/`
- `app/pages/materiel/pointage/`
- `app/pages/materiel/controles/`
...
Spec : `docs/specs/erp-audit-round-2-roadmap/06-etudes.md`.
...
Fichiers à toucher :
- `app/pages/etudes/bibliotheque-prix/` (onglet DPU)
- `app/pages/etudes/metres/` (DPGF generation)
- `app/pages/etudes/devis/` (génération depuis DPGF)
- `app/pages/etudes/aoc/` (soumission wizard)
- `app/etudes/services/` (DPUService, DPGFService)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/07-marches.md`.
...
Fichiers à toucher :
- `app/pages/marches/` (étendre)
- `app/pages/marches/dgd/` (nouveau)
- `app/pages/marches/os/` (nouveau)
- `app/pages/marches/reception/` (nouveau)
- `app/marches/services/` (DGDService, OSService, SituationGenerationService)
- `app/shell/erp-nav.generated.ts` (fusion sidebar)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/08-finance.md`.
...
Fichiers à toucher :
- `app/pages/finance/lettrage/` (nouveau)
- `app/pages/finance/recouvrement/` (nouveau)
- `app/pages/finance/effets/` (nouveau)
- `app/pages/finance/virements/remise/` (nouveau)
- `app/pages/finance/rapprochement/` (étendre)
- `app/pages/finance/caisses-chantier/` (nouveau)
- `app/finance/services/` (LettrageService, RecouvrementService, EfactureService)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/09-rh.md`.
Findings : M-RH-01..14.
Sprint cible : S7–S8.
...
Fichiers à toucher :
- `app/pages/rh/pointage/` (durcir, multi-pointage équipe)
- `app/pages/rh/contrats/` (nouveau)
- `app/pages/rh/heures-sup/` (nouveau)
- `app/pages/rh/frais-deplacement/` (nouveau)
- `app/pages/rh/carriere/` (nouveau)
- `app/pages/rh/conges/` (étendre)
- `app/pages/rh/interim/` (nouveau)
- `app/rh/services/paie-engine.service.ts` (étendre HS, CIMR)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/10-hse.md`.
...
Fichiers à toucher :
- `app/hse/hse.routes.ts` (vérifier + alias /qualite)
- `app/pages/hse/` (étendre incidents, NC, PPSPS, PHS, causerie, audits, EPI, FDS, evac, KPIs)
- `app/hse/services/` (IncidentService, HseKpiService)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/11-pilotage.md`.
...
Fichiers à toucher :
- `app/pages/pilotage-analyses/rentabilite/` (étendre)
- `app/pages/pilotage-analyses/financier/`
- `app/pages/pilotage-analyses/stock/`
- `app/pages/pilotage-analyses/achats/`
- `app/pages/pilotage-analyses/rh/`
- `app/pages/pilotage-analyses/what-if/` (nouveau)
- `app/pilotage/services/cash-flow-projection.service.ts` (étendre)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/12-approbations.md`.
...
Fichiers à toucher :
- `app/approbations/services/approval-engine.service.ts` (nouveau)
- `app/approbations/models/` (étendre)
- `app/pages/approbations/` (étendre inbox)
- `app/pages/administration/approbations/matrice/` (nouveau)
- `app/pages/administration/delegations/` (nouveau)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/13-admin.md`.
...
Fichiers à créer :
- `app/administration/administration.routes.ts` (étendre)
- `app/pages/administration/hub/admin-hub.page.ts`
- `app/pages/administration/utilisateurs/` (étendre)
- `app/pages/administration/roles/` (étendre)
- `app/pages/administration/societes/`
- `app/pages/administration/etablissements/`
- `app/pages/administration/referentiels/{clients,moa,banques}/`
- `app/pages/administration/audit-log/`
- `app/pages/administration/templates-docs/`
- `app/pages/administration/numerotation/`
- `app/pages/administration/mappings-comptables/`
- `app/pages/administration/backup/`
...
Spec : `docs/specs/erp-audit-round-2-roadmap/14-transverse.md`.
...
Spec : `docs/specs/erp-audit-round-2-roadmap/15-mobile.md`.
...
- `app/mobile/` (nouveau périmètre)
- `app/mobile/m.routes.ts`
- `app/mobile/services/offline-storage.service.ts` (Dexie)
- `app/mobile/services/sync-queue.service.ts`
- `app/mobile/services/conflict-resolver.service.ts`
- `app/platform/lib/anatomy/components/atoms/signature-canvas/`
- `app/pages/rh/pointage/` (durcir Round 1 13.1)
...
Spec : `docs/specs/erp-audit-round-2-roadmap/16-integrations.md`.
...
- `app/integrations/services/indices-btp-import.service.ts`
...
Spec : `docs/specs/erp-audit-round-2-roadmap/17-maroc.md`.
Findings : M-MA-01..14.
...
- `app/shared/validators/` (étendre Ice/Rib/If)
- `app/shared/services/fiscal-settings.service.ts` (étendre)
- `app/finance/services/retenue-source.service.ts` (nouveau)
- `app/finance/services/timbre-fiscal.service.ts` (nouveau)
- `app/rh/services/paie-engine.service.ts` (étendre CIMR)
- `app/shared/services/jours-feries-ma.service.ts` (nouveau)
- `app/shared/data/regions-ma.ts` (nouveau)
- `app/shared/data/banques-ma.ts` (nouveau)
