...
```
app/pages/inventory/                                      # 16 sous-routes Round 1
app/pages/inventory/mouvements/receptions/
app/pages/inventory/mouvements/sorties/                   # Round 1 5.3
app/pages/inventory/mouvements/transferts/
app/pages/inventory/catalogue/articles/                   # Round 1 5.2 (PMP + posteBudgetId)
app/inventory/services/inventory-mock.service.ts
app/inventory/services/inventory-tx.facade.ts             # Round 1 5.7 V2
app/inventory/services/stock-budget-sync.service.ts
```
...
**Fichiers** :
- `app/pages/inventory/mobile/scanner/scanner.component.ts` (nouveau)
