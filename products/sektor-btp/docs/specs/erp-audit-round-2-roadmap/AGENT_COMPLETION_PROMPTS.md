...
> **Source de vérité :** `docs/specs/erp-audit-round-2-roadmap/00-PROGRESS.md` (snapshot **2026-05-13**).
> **Audit d'origine :** `docs/specs/ROUNDéAUDIT/AUDIT_round_2`.
> **Règles communes (à coller en tête de chaque session si besoin) :**
> - Workspace : `products/sektor-btp/web/` (Angular ERP).
...
Référence : `docs/specs/erp-audit-round-2-roadmap/02-chantiers.md` et `14-transverse.md`.
Pré-requis : lire `docs/specs/erp-audit-roadmap/00-PROGRESS.md` (Round 1) sections 02 et 03 pour comprendre l'existant.
...
Référence : `docs/specs/erp-audit-round-2-roadmap/03-achats.md`, `06-etudes.md`, `07-marches.md`.
...
Référence : `docs/specs/erp-audit-round-2-roadmap/04-stock.md`, `05-materiel.md`.
...
Référence : `docs/specs/erp-audit-round-2-roadmap/08-finance.md`, `09-rh.md`, `17-maroc.md`.
...
Référence : `docs/specs/erp-audit-round-2-roadmap/10-hse.md`, `11-pilotage.md`, `12-approbations.md`, `13-admin.md`.
...
Référence : `docs/specs/erp-audit-round-2-roadmap/15-mobile.md`, `16-integrations.md`.
...
Référence : `docs/specs/erp-audit-round-2-roadmap/01-dashboard.md`, `14-transverse.md` (M-TRA-04..20).
