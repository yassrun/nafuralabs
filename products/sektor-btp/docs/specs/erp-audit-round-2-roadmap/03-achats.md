...
```
app/pages/achats/                                # DA, AO, BC, Contrats, Fournisseurs
app/pages/inventory/mouvements/receptions/       # Réceptions Round 1 (à intégrer côté BC)
app/pages/achats/fournisseurs/                   # référentiel
app/pages/finance/factures-fournisseurs/         # facture côté finance
app/shared/services/fiscal-settings.service.ts   # Round 1
```
