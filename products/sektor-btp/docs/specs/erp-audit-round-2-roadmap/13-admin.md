...
```
app/pages/administration/                       # ⚠️ Round 1 partiel
app/pages/administration/iam/                   # Round 1 8.1 utilisateurs
app/pages/administration/iam/roles/              # Round 1 8.2 rôles
app/pages/administration/societe/                # Round 1 8.3, 8.4 partial
app/shell/societe.service.ts                    # Round 1 multi-tenant
app/shell/components/societe-switcher/           # Round 1
app/administration/                              # services
app/shared/services/fiscal-settings.service.ts   # Round 1 6.7 paramètres fiscaux
app/shared/services/erp-audit.service.ts          # Round 1 14.1 audit log
app/shared/services/numbering.service.ts          # Round 1 numérotation
```
...
**Acceptance criteria** :
- [x] `/admin` accessible (hub) — `app/pages/administration/hub/admin-hub.page.ts` + route `path: 'admin'` dans `app.routes.ts` (avant `APPLICATION_ROUTES` pour priorité matcher)
...
**Fichier** : `app/administration/administration.routes.ts`
