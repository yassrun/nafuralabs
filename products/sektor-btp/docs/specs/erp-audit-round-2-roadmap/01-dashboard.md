...
```
app/pages/dashboard/dashboard.page.ts       # 8 tuiles actuelles
app/pages/dashboard/dashboard.page.html
app/platform/lib/anatomy/components/organisms/widgets/       # widget list-widget existant
app/shared/services/                         # services KPI
app/shared/iam/                              # rôles disponibles
```
...
**Fichiers** :
- `app/pages/dashboard/dashboard.page.ts` (+ rendre les tuiles cliquables)
- `app/pages/dashboard/widgets/kpi-tile.component.ts` (nouveau composant ou utiliser `nf-kpi-card`)
...
**Fichiers** :
- `app/pages/dashboard/widgets/ca-cumul-chart.component.ts` (nouveau)
- `app/pages/dashboard/widgets/top-chantiers-alerte.component.ts` (nouveau)
- `app/pages/dashboard/widgets/marge-sparkline.component.ts` (nouveau)
...
**Fichiers** :
- `app/pages/dashboard/dashboard-filters.component.ts` (nouveau)
- `app/pages/dashboard/dashboard-filters.service.ts` (nouveau, état partagé)
...
**Fichiers** :
- `app/pages/dashboard/alerts-panel.component.ts` (nouveau)
- `app/shared/services/alerts.service.ts` (nouveau)
...
**Fichiers** :
- `app/pages/dashboard/dashboard-export.service.ts` (nouveau)
