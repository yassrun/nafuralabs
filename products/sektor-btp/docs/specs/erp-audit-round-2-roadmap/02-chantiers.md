...
```
app/pages/chantiers/                                   # liste + détail
app/pages/chantiers/detail/chantier-detail.page.ts     # fiche existante (Round 1)
app/pages/chantiers/detail/chantier-detail-placeholder.page.ts  # ⚠️ placeholder à remplacer
app/chantiers/mock/chantiers-mock.service.ts           # mock service
app/chantiers/mock/seeds.ts                            # SEED_CHANTIERS canon
app/chantiers/chantiers.routes.ts                       # routing
app/pages/chantiers/planning/                          # Gantt
app/pages/chantiers/attachements/                      # carnets attachement
app/pages/chantiers/journal/                            # journal chantier
...
**Fichiers** :
- `app/pages/chantiers/create/chantier-create.page.ts` (nouveau)
- `app/pages/chantiers/create/steps/` (5 sous-composants)
- `app/chantiers/chantiers.routes.ts` (ajouter `/chantiers/new`)
- `app/pages/chantiers/list/chantier-listing.page.ts` (ajouter CTA `+ Nouveau chantier`)
...
**Fichiers** :
- `app/pages/chantiers/detail/chantier-detail.page.html` (réorganiser)
- `app/pages/chantiers/detail/tabs/` (nouveaux composants par onglet)
...
**Fichiers** :
- `app/pages/chantiers/map/chantiers-map.page.ts` (nouveau)
...
**Fichiers** :
- `app/pages/chantiers/attachements/sign/attachement-sign.page.ts` (nouveau)
- `app/pages/chantiers/attachements/services/e-signature.service.ts` (mock + interface)
...
**Fichiers** :
- `app/pages/chantiers/photos/photos.page.ts` (nouveau)
- `app/pages/chantiers/photos/photo-gallery.component.ts`
...
**Fichiers** :
- `app/pages/chantiers/plans/plans-viewer.component.ts` (nouveau)
...
**Fichiers** :
- `app/pages/chantiers/planning/export/planning-export.service.ts` (nouveau)
