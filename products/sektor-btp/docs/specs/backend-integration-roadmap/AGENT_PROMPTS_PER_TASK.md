...
> **Source de vérité :** `docs/specs/backend-integration-roadmap/00-PROGRESS.md`.
> **Audit d'origine :** `docs/migration_plan.md` + `docs/specs/backend-integration-roadmap/00-MOCK-INVENTORY.md`.
...
```text
Règles projet :
- Repo : monorepo Nafura. Backend dans `backend/`, frontend Angular dans `products/sektor-btp/web/`.
- Workspace agent : `products/sektor-btp/backend/` pour le code Java + `web/` pour la désinjection mock.
- AVANT de coder : lire OBLIGATOIREMENT
  - `docs/specs/backend-integration-roadmap/00-ARCHITECTURE.md` (patterns socle, layout, conventions)
  - `docs/specs/backend-integration-roadmap/00-PROGRESS.md` (statut courant — ne pas refaire ce qui est `[x]`)
...
Spec : `docs/specs/backend-integration-roadmap/01-shared-foundation.md` (section B-FND-01).
...
- `web/app/pages/inventory/catalogue/{items,item-prices}/services/`
- `web/app/pages/inventory/configuration/{item-categories,item-types,unit-of-measures,uo-mcategories}/services/`
- `web/app/pages/inventory/mouvements/{inventory-txes,inventory-tx-lines}/services/`
- `web/app/pages/inventory/suivi/stock-balances/services/`
- `web/app/pages/finance/configuration/{currencies,exchange-rates,payment-terms}/services/`
...
Spec : `docs/specs/backend-integration-roadmap/01-shared-foundation.md` (section B-FND-02).
...
5. Validation `IceValidator` (15 chiffres + clé) côté backend portant l'algo de `web/app/shared/validators/`.
6. Seeds Liquibase `context="seed-demo"` : reprendre les fournisseurs de `web/app/achats/mock/achats-mock.service.ts` et les clients de `web/app/ventes/mock/ventes-mock.service.ts`.
...
Spec : `docs/specs/backend-integration-roadmap/01-shared-foundation.md` (section B-FND-03).
...
Livrables :
1. Auditer `web/app/**/*.facade.ts` pour recenser les patterns d'autocomplete (charger fournisseurs / clients / articles / dépôts / devises).
...
Spec : `docs/specs/backend-integration-roadmap/01-shared-foundation.md` (section B-FND-04).
Wave : 0. Indépendant.
...
Spec : `docs/specs/backend-integration-roadmap/01-shared-foundation.md` (section B-FND-05).
...
Spec : `docs/specs/backend-integration-roadmap/02-inventory.md` (section B-INV-01).
...
4. Désinjection mock :
   - `web/app/pages/inventory/catalogue/articles/services/article-api.service.ts` → pure HTTP
   - `web/app/pages/inventory/catalogue/articles/services/article.facade.ts` → retire `inject(InventoryMockService)`
   - 5 composants `web/app/inventory/components/{inventaire,perte,reception,retour,transfert}-lines-editor/` → consommer `ItemApiService.getLookup(...)` au lieu du mock.

Acceptance criteria :
- [ ] `GET /api/v1/items` renvoie les articles avec les champs BTP.
- [ ] `grep "InventoryMockService" web/app/pages/inventory/catalogue/` → vide.
...
Spec : `docs/specs/backend-integration-roadmap/02-inventory.md` (section B-INV-02).
Wave : 1.
...
4. Désinjection : `web/app/pages/inventory/configuration/depots/services/location-config.facade.ts` → consomme `/api/v1/warehouses`.
...
Spec : `docs/specs/backend-integration-roadmap/02-inventory.md` (section B-INV-03).
...
3. Désinjection : `web/app/pages/inventory/suivi/etat-stock/services/etat-stocks.facade.ts` + `valorisation.facade.ts`.
...
Spec : `docs/specs/backend-integration-roadmap/02-inventory.md` (section B-INV-04).
...
Spec : `docs/specs/backend-integration-roadmap/02-inventory.md` (section B-INV-05).
...
5. Désinjection : `web/app/pages/inventory/reservations/` + `magasin-chantier.page.ts`.
...
Spec : `docs/specs/backend-integration-roadmap/02-inventory.md` (section B-INV-06).
...
3. Désinjection : `web/app/pages/inventory/magasin-chantier/magasin-chantier.page.ts`.
...
Spec : `docs/specs/backend-integration-roadmap/02-inventory.md` (section B-INV-07).
...
3. Désinjection :
   - `web/app/pages/inventory/catalogue/materiel/services/materiel-api.service.ts` → pure HTTP
...
Spec : `docs/specs/backend-integration-roadmap/03-finance.md` (section B-FIN-01).
Wave : 1.
...
3. Désinjection :
   - `web/app/pages/finance/devises/services/devise-api.service.ts` → pure HTTP
   - `web/app/pages/finance/taux-change/services/taux-change-api.service.ts` + `.facade.ts`
...
Spec : `docs/specs/backend-integration-roadmap/03-finance.md` (section B-FIN-02).
...
Spec : `docs/specs/backend-integration-roadmap/03-finance.md` (section B-FIN-03).
...
5. Désinjection :
   - `web/app/pages/finance/journaux/**` (4 fichiers)
...
Spec : `docs/specs/backend-integration-roadmap/03-finance.md` (section B-FIN-04).
...
3. Désinjection : `web/app/pages/finance/reglements/**` (2 fichiers).
...
Spec : `docs/specs/backend-integration-roadmap/03-finance.md` (section B-FIN-05).
...
3. Désinjection : `web/app/pages/finance/lettrage/lettrage.page.ts`.
...
Spec : `docs/specs/backend-integration-roadmap/03-finance.md` (section B-FIN-06).
Wave : 1. Dépendance : B-FIN-04.
...
4. Désinjection : `web/app/pages/finance/rapprochement/rapprochement.page.ts`.
...
Spec : `docs/specs/backend-integration-roadmap/03-finance.md` (section B-FIN-07).
Wave : 1. Dépendance : B-FIN-04.
...
Spec : `docs/specs/backend-integration-roadmap/03-finance.md` (section B-FIN-08).
Wave : 1. Dépendance : B-FIN-04.
...
Spec : `docs/specs/backend-integration-roadmap/04-achats.md` (section B-ACH-01).
...
5. Désinjection :
   - `web/app/pages/achats/demandes/services/demande-api.service.ts` → pure HTTP
   - `web/app/pages/achats/demandes/services/demande.facade.ts` → retire `inject(AchatsMockService)`
...
Spec : `docs/specs/backend-integration-roadmap/04-achats.md` (section B-ACH-02).
...
3. Service `AoScoringService` portant la logique de `web/app/achats/services/matching.service.ts` (prix /50, délai /15, qualité /15, historique /10, art187 /10).
4. Désinjection :
...
Spec : `docs/specs/backend-integration-roadmap/04-achats.md` (section B-ACH-03).
...
Spec : `docs/specs/backend-integration-roadmap/04-achats.md` (section B-ACH-04).
Wave : 2. Dépendance : B-ACH-01.
...
Spec : `docs/specs/backend-integration-roadmap/04-achats.md` (section B-ACH-05).
...
Spec : `docs/specs/backend-integration-roadmap/04-achats.md` (section B-ACH-06).
...
Spec : `docs/specs/backend-integration-roadmap/04-achats.md` (section B-ACH-07).
...
2. Service `MatchingService` (port Java de `web/app/achats/services/matching.service.ts`).
...
5. Désinjection : `pages/finance/factures-fournisseurs/**` (2 fichiers) + `web/app/achats/services/matching.service.ts` (orchestrateur frontend pur).
...
Spec : `docs/specs/backend-integration-roadmap/05-ventes.md` (section B-VEN-01).
...
2. Refactorer `web/app/pages/ventes/clients/services/client-api.service.ts` pour utiliser `basePath = '/api/v1/partners'` + `defaultQuery = { role: 'CLIENT' }`.
...
Spec : `docs/specs/backend-integration-roadmap/05-ventes.md` (section B-VEN-02).
...
Spec : `docs/specs/backend-integration-roadmap/05-ventes.md` (section B-VEN-03).
...
Spec : `docs/specs/backend-integration-roadmap/05-ventes.md` (section B-VEN-04).
...
Spec : `docs/specs/backend-integration-roadmap/05-ventes.md` (section B-VEN-05).
...
Spec : `docs/specs/backend-integration-roadmap/05-ventes.md` (section B-VEN-06).
Wave : 2. Dépendance : B-VEN-04.
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-01).
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-02).
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-03).
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-04).
Wave : 3. Dépendance : B-CHA-02.
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-05).
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-06).
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-07).
Wave : 3. Dépendance : B-CHA-01.
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-08).
Wave : 3. Dépendance : B-CHA-01.
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-09).
...
Spec : `docs/specs/backend-integration-roadmap/06-chantiers.md` (section B-CHA-10).
...
```
grep -rE "inject\((ChantiersMockService|AttachementMockService|AvancementMockService|DocumentsMockService|SousTraitanceMockService|PlanningMockFacade)\)" web/app/pages/chantiers/ → vide
```
...
Spec : `docs/specs/backend-integration-roadmap/07-etudes.md` (section B-ETU-01).
...
Spec : `docs/specs/backend-integration-roadmap/07-etudes.md` (section B-ETU-02).
...
Spec : `docs/specs/backend-integration-roadmap/07-etudes.md` (section B-ETU-03).
...
Spec : `docs/specs/backend-integration-roadmap/07-etudes.md` (section B-ETU-04).
Wave : 3. Dépendance : B-ETU-01.
...
Spec : `docs/specs/backend-integration-roadmap/07-etudes.md` (section B-ETU-05).
...
Spec : `docs/specs/backend-integration-roadmap/07-etudes.md` (section B-ETU-06).
...
Spec : `docs/specs/backend-integration-roadmap/08-rh.md` (section B-RH-01).
...
Spec : `docs/specs/backend-integration-roadmap/08-rh.md` (section B-RH-02).
...
Spec : `docs/specs/backend-integration-roadmap/08-rh.md` (section B-RH-03).
...
Spec : `docs/specs/backend-integration-roadmap/08-rh.md` (section B-RH-04).
...
Spec : `docs/specs/backend-integration-roadmap/08-rh.md` (section B-RH-05).
Wave : 4. Dépendance : B-RH-01.
...
Livrables :
1. 2 entités + CRUD socle.
2. Service `PaieEngineService` portant la logique de `web/app/rh/services/paie-engine.service.ts`.
...
Spec : `docs/specs/backend-integration-roadmap/08-rh.md` (section B-RH-06).
...
Spec : `docs/specs/backend-integration-roadmap/08-rh.md` (section B-RH-07).
Wave : 4. Dépendance : B-RH-01.
...
Spec : `docs/specs/backend-integration-roadmap/08-rh.md` (section B-RH-08).
Wave : 4. Dépendance : B-RH-01.
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-01).
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-02).
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-03).
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-04).
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-05).
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-06).
Wave : 4. Dépendance : Wave 3 Chantiers.
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-07).
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-08).
Wave : 4. Dépendance : Wave 3 Chantiers.
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-09).
Wave : 4. Dépendance : Wave 3 Chantiers.
...
Spec : `docs/specs/backend-integration-roadmap/09-hse.md` (section B-HSE-10).
Wave : 4. Dépendance : B-HSE-01.
...
Spec : `docs/specs/backend-integration-roadmap/10-marches.md` (section B-MAR-01).
...
Spec : `docs/specs/backend-integration-roadmap/10-marches.md` (section B-MAR-02).
...
Spec : `docs/specs/backend-integration-roadmap/10-marches.md` (section B-MAR-03).
Wave : 5. Dépendance : B-MAR-01.
...
Spec : `docs/specs/backend-integration-roadmap/10-marches.md` (section B-MAR-04).
...
Spec : `docs/specs/backend-integration-roadmap/10-marches.md` (section B-MAR-05).
Wave : 5. Dépendance : B-MAR-01.
...
Spec : `docs/specs/backend-integration-roadmap/10-marches.md` (section B-MAR-06).
Wave : 5. Dépendance : B-MAR-01.
...
Spec : `docs/specs/backend-integration-roadmap/10-marches.md` (section B-MAR-07).
Wave : 5. Dépendance : B-MAR-01.
...
Spec : `docs/specs/backend-integration-roadmap/10-marches.md` (section B-MAR-08).
...
Spec : `docs/specs/backend-integration-roadmap/11-approbations.md` (section B-APR-01).
...
Spec : `docs/specs/backend-integration-roadmap/11-approbations.md` (section B-APR-02).
...
Spec : `docs/specs/backend-integration-roadmap/11-approbations.md` (section B-APR-03).
...
Spec : `docs/specs/backend-integration-roadmap/11-approbations.md` (section B-APR-04).
Wave : 5. Dépendance : B-APR-02.
...
Spec : `docs/specs/backend-integration-roadmap/12-dashboard-analytics.md` (section B-DSH-01).
...
Spec : `docs/specs/backend-integration-roadmap/12-dashboard-analytics.md` (section B-DSH-02).
Wave : 5. Dépendances : toutes Waves précédentes.
...
Spec : `docs/specs/backend-integration-roadmap/12-dashboard-analytics.md` (section B-DSH-03).
...
3. Désinjection :
   ...
   - `pages/pilotage-analyses/services/pilotage-analyses-data.service.ts`
4. Validation finale : `grep MockService` sur tout `web/app/` (hors specs) → vide.
