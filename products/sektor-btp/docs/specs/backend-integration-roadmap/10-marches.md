...
- Logique métier critique (DGD, formule K, propagation avenant) est dans `web/app/pages/marches/services/marches-mock.service.ts` → à descendre côté backend.
