...
**Acceptance criteria :**
- [ ] `grep "ChantiersMockService\|AttachementMockService\|AvancementMockService\|DocumentsMockService\|SousTraitanceMockService\|PlanningMockFacade" web/app/pages/chantiers/` → vide.
