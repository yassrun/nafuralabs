...
> **Goal :** remplacer **tous les mocks** du frontend ERP (`web/app/`) par des APIs Spring Boot réelles, **module par module**, en gardant **exactement la même séparation modulaire** que le frontend.
>
> **Source d'analyse :** `docs/migration_plan.md` + audit codebase Round 2 (`docs/specs/erp-audit-round-2-roadmap/`).
>
...
- **40** fichiers `*-api.service.ts` côté Angular sous `web/app/pages/**`.
...
| Sidebar frontend | Dossier `web/app/` | Backend cible | Fichier roadmap |
|---|---|---|---|
