...
-- =============================================================================
-- CONSTRUCTION / BTP: Bon de Commande
-- =============================================================================
INSERT INTO doc_type_definition (
  ...
  '7f1f3b9b-3a1c-4e7b-90c1-0c0c0c0c0002',
  'btp',
  'BON_COMMANDE',
  1,
  'Bon de commande',
  'Bon de commande (purchase order). Extraction of header, buyer/supplier, totals, and line items.',
  'You are a document extraction assistant. Extract data for a Bon de Commande (Purchase Order).
...
- Numbers must be numbers (not strings).',
  '{
    "type": "object",
    "required": ["orderReference", "date", "buyer", "supplier", "currency", "totals", "items"],
    "properties": {
