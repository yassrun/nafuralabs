...
import ma.nafura.finance.service.FinanceAnalyticsBucketService;
...
@SecuredResource(domain = "finance", feature = "analytics", resource = "analytics")
public class FinanceAnalyticsController {

    private final FinanceAnalyticsBucketService service;

    public FinanceAnalyticsController(FinanceAnalyticsBucketService service) {
        this.service = service;
    }

    @GetMapping
    @RequirePermission("finance.analytics.read")
