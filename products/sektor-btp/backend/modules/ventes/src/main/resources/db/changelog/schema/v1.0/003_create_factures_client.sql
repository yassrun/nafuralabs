CREATE TABLE IF NOT EXISTS factures_client (
    ...
    retenue_garantie_taux   NUMERIC(8, 4) NOT NULL DEFAULT 0,
    retenue_garantie_montant NUMERIC(18, 4) NOT NULL DEFAULT 0,
    resorption_avance_montant NUMERIC(18, 4) NOT NULL DEFAULT 0,
    ras_taux                NUMERIC(8, 4) NOT NULL DEFAULT 0,
    ras_montant             NUMERIC(18, 4) NOT NULL DEFAULT 0,
