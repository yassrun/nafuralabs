...
import type { BookingDraft } from '@shared/types'
...
export default function App() {
  ...
  const openProApp = () => {
    globalThis.open(PRO_APP_URL, '_blank', 'noopener,noreferrer')
  }
  ...
  const renderScreen = () => {
    ...
    switch (appState.currentScreen) {
      ...
      case 'login':
        return (
          <LoginScreen
            onBack={() => navigate(appState.authReturnScreen ? 'booking-select-time' : 'home')}
  ...
  return (
    <IonContent>
      <div style={{ paddingBottom: '40px' }}>
        ...
        <div className="client-footer-pro">
          <button type="button" className="client-footer-pro__link" onClick={onOpenPro}>
