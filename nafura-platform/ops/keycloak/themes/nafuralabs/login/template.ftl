...
<div class="${properties.kcLogin!}">
  <div class="${properties.kcLoginContainer!}">
    <main class="${properties.kcLoginMain!}">
      <div class="${properties.kcLoginMainHeader!} nafura-login-main-header">
        <#if realm.internationalizationEnabled  && locale.supported?size gt 1>
        <div class="${properties.kcLoginMainHeaderUtilities!} nafura-login-locale">
        ...
        <div class="nafura-login-header" id="kc-page-title"><#nested "header"></div>
      </div>
