...
public class GeminiProvider implements AiProvider {
    ...
    private String buildDevAskFallback() {
        return """
            Bonjour ! Je suis l'assistant Nafura en **mode démo** (clé Gemini non configurée).

            Posez une question de navigation ou de lecture une fois Gemini configuré.

            Pour activer l'IA complète : renseignez `api_key` dans Vault puis redémarrez le backend.
            """.trim();
    }
}
