...
public interface DocumentRepository extends JpaRepository<Document, UUID> {
    ...
    Optional<Document> findFirstByTenantIdAndChecksumSha256AndStatus(
            UUID tenantId, String checksumSha256, DocumentStatus status);

    long countByTenantIdAndStorageKeyAndStatus(
            UUID tenantId, String storageKey, DocumentStatus status);
