...
/**
 * SSOT Git : nafura-platform/raster-src/lots/document-reader/ux/carte-des-doutes-wireframe.canvas.tsx
 ...
 * - Recyclage : pas de 4e table — data-table / tree-table / record-table existent
 ...
 * - CTA Enregistrer reste en footer sticky (comme etude-decompo)
 */
...
function ListeView() {
  return (
    <Stack gap={16}>
      ...
      <Text tone="secondary" size="small">
        Inventaire actuel :{" "}
        <Code>nf-smart-import-data-table</Code> (lignes) +{" "}
        <Code>nf-smart-import-record-table</Code> (en-tête). Les deux fusionnent
        encore les issues sous la ligne — à scinder après validation de ce
        canvas.
      </Text>
