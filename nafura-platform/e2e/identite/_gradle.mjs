/**
 * Lance les tests JUnit du jar iam (membres / invitation), une fois par run.
 * Run : node --test nafura-platform/e2e/identite/*.test.mjs
 */
...
const TESTS = [
  "ma.nafura.platform.administration.iam.IdentiteBaselineTest.deuxTenants",
  "ma.nafura.platform.administration.iam.IdentiteBaselineTest.inviterMembre",
  "ma.nafura.platform.administration.iam.IdentiteBaselineTest.accepterInvitation",
  "ma.nafura.platform.administration.iam.IdentiteBaselineTest.retirerMembre",
];
...
export function runIdentiteJunit() {
