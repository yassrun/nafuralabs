/**
 * Lance les tests JUnit baseline du module approbation, une fois par run.
 * Run : node --test nafura-platform/e2e/approbation/*.test.mjs
 */
...
const RESULTS = path.join(
  BACKEND,
  "approbation/build/test-results/test"
);
const LOCK = path.join(RESULTS, "..", "approbation-e2e.lock");

const TESTS = [
  "ma.nafura.platform.collaboration.workflow.ApprobationBaselineTest.demander",
  "ma.nafura.platform.collaboration.workflow.ApprobationBaselineTest.accepter",
  "ma.nafura.platform.collaboration.workflow.ApprobationBaselineTest.refuser",
  "ma.nafura.platform.collaboration.workflow.ApprobationBaselineTest.deuxTenants",
  "ma.nafura.platform.collaboration.workflow.ApprobationBaselineTest.etapes",
  "ma.nafura.platform.collaboration.workflow.ApprobationBaselineTest.chaine",
];
...
function runGradle() {
  const args = [":platform:approbation:test"];
...
export function runApprobationJunit() {
