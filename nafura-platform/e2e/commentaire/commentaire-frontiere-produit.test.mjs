/**
 * CH-00-INIT-commentaire · commentaire-frontiere-produit · AC-3
 * Compile : zéro type métier produit dans commentaire (main jar + widget).
 */
...
const ROOTS = [
  "nafura-platform/sources/backend/commentaire/src/main",
  "nafura-platform/sources/web/app/commentaire",
];
...
test("commentaire-frontiere-produit", () => {
