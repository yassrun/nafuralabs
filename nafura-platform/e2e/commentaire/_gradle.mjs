/**
 * Lance les tests JUnit baseline du module comment, une fois par run.
 * Run : node --test nafura-platform/e2e/commentaire/*.test.mjs
 */
...
const RESULTS = path.join(
  BACKEND,
  "commentaire/build/test-results/test"
);
const LOCK = path.join(RESULTS, "..", "commentaire-e2e.lock");

const TESTS = [
  "ma.nafura.platform.collaboration.comment.CommentBaselineTest.posterEtLire",
  "ma.nafura.platform.collaboration.comment.CommentBaselineTest.deuxTenants",
  "ma.nafura.platform.collaboration.comment.CommentBaselineTest.auteurSeul",
  "ma.nafura.platform.collaboration.comment.CommentBaselineTest.retirer",
  "ma.nafura.platform.collaboration.comment.CommentBaselineTest.repondre",
];
...
function runGradle() {
  const args = [":platform:commentaire:test"];
...
export function runCommentaireJunit() {
