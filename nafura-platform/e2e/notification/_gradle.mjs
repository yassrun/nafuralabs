/**
 * Lance les tests JUnit du jar notification, une fois par run.
 * Run : node --test nafura-platform/e2e/notification/*.test.mjs
 */
...
const RESULTS = path.join(
  BACKEND,
  "notification/build/test-results/test"
);
const LOCK = path.join(RESULTS, "..", "notification-e2e.lock");

const TESTS = [
  "ma.nafura.platform.collaboration.notification.NotificationBaselineTest.deposerEtLister",
  "ma.nafura.platform.collaboration.notification.NotificationBaselineTest.deuxTenants",
  "ma.nafura.platform.collaboration.notification.NotificationBaselineTest.marquerLue",
  "ma.nafura.platform.collaboration.notification.NotificationBaselineTest.autreDestinataire",
];
...
function runGradle() {
  const args = [":platform:notification:test"];
...
export function runNotificationJunit() {
