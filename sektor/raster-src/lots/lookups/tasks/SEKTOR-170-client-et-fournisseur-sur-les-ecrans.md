...
assignee: agent
gate: none
blocked_by: [SEKTOR-168, SEKTOR-169]
tags: [sektor, ux]
---

# Client et fournisseur sur les écrans

> Plus de dump pageSize 500. Debounce → `partnersByRole(role, q)`. Devis, BC, contrat, chantier, facture vente. Réf. CONTRAT AC-3 AC-4 AC-9 AC-10 AC-11.
...
écarts / dette       Listing filters (devis, BC, …) encore vides : SEKTOR-171. Autres `lookupKey` (chantier, employé, dépôt, …) : 171. Picker article inchangé (AC-13).
