...
5. **plier-archi** — Études consomme Catalogue via `api` (déjà PLAN, tasks balayées)
6. **stabiliser-sources** / **aligner-arbre** / **monter-angular-*** — lots d’arbre, pas ce cycle
