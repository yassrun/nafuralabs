...
3. **etudes** — Extraire + parcours QA livrés · raffinement intégrité/IA/UX dans `raffinement-etude` · ancien panneau consultation **à remplacer** par le lot `consultation`
