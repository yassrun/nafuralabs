...
import ma.nafura.chantiers.domain.model.ChantierAffectation;
...
public class ApproverResolutionService {
    ...
    public Optional<ResolvedApprover> resolve(String roleCode, String chantierId, LocalDate onDate) {
