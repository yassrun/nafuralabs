...
import type { DetailActionConfig, StatusMachineConfig } from '@platform/lib/anatomy/types';
import type { Incident, StatutIncident } from '@app/hse/models';
import { INCIDENT_STATUS_KEYS } from '@app/socle/shell/i18n-labels';
import {
