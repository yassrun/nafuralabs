...
import { BirdPyramidHseComponent } from '@app/socle/dashboard/widgets/bird-pyramid-hse.component';
...
@Component({
  ...
  imports: [RouterLink, TranslateModule, PageShellComponent, PageHeaderComponent, BirdPyramidHseComponent],
  template: `
