...
const HSE_BASE_ROUTES: Routes = [
  { path: 'hse', pathMatch: 'full', redirectTo: 'hse/tableau-bord' },
  {
    ...
    loadComponent: () =>
      import('./tableau-bord-hse/tableau-bord-hse.page').then((m) => m.TableauBordHsePage),
    data: { title: 'Tableau de bord HSE', breadcrumb: 'Tableau de bord' },
  },
  {
    path: 'hse/epi',
    loadChildren: () =>
      import('./epi/epi.routes').then((m) => m.EPI_ROUTES),
    data: { title: 'Registre EPI', breadcrumb: 'EPI' },
  },
  {
    path: 'hse/incidents',
    loadChildren: () =>
      import('./incidents/incident.routes').then((m) => m.INCIDENT_ROUTES),
  },
  {
    path: 'hse/non-conformites',
    loadChildren: () =>
      import('./non-conformites/nc.routes').then((m) => m.NC_ROUTES),
  },
  {
    path: 'hse/inspections',
    loadChildren: () =>
      import('./inspections/inspection.routes').then((m) => m.INSPECTION_ROUTES),
  },
  {
    path: 'hse/formations',
    loadChildren: () =>
      import('./formations/formation.routes').then((m) => m.FORMATION_ROUTES),
  },
  {
    path: 'hse/duer',
    loadComponent: () =>
      import('./duer/duer-listing.page').then((m) => m.DuerListingPage),
    data: { title: 'DUER', breadcrumb: 'DUER' },
  },
  {
    path: 'hse/ppsps',
    loadComponent: () =>
      import('./ppsps/ppsps-listing.page').then((m) => m.PpspsListingPage),
    data: { title: 'PPSPS', breadcrumb: 'PPSPS' },
  },
  {
    path: 'hse/phs',
    loadComponent: () =>
      import('./phs/phs-listing.page').then((m) => m.PhsListingPage),
    data: { title: 'PHS société', breadcrumb: 'PHS' },
  },
  {
    path: 'hse/visites-medicales',
    loadComponent: () =>
      import('./visites-medicales/visites-medicales-listing.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./registres-legaux/registres-legaux.page').then(
