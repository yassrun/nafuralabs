...
// Phase 1.2: centralised keys at `@app/socle/shell/i18n-labels` → BCC_STATUS_KEYS.

// @i18n-exempt — @deprecated Phase 1.2 — see BCC_STATUS_KEYS in @app/socle/shell/i18n-labels.
