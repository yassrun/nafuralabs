...
export const PILOTAGE_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./marges-chantier/marges-chantier.page').then(m => m.MargesChantierPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./marge-consolidee/marge-consolidee.page').then(m => m.MargeConsolideePage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../pilotage-analyses/rentabilite/rentabilite-analyses.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../pilotage-analyses/financier/financier-analyses.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../pilotage-analyses/stock/stock-analyses.page').then((m) => m.StockAnalysesPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../pilotage-analyses/achats/achats-analyses.page').then((m) => m.AchatsAnalysesPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../pilotage-analyses/rh/rh-analyses.page').then((m) => m.RhAnalysesPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../pilotage-analyses/what-if/what-if-analyses.page').then((m) => m.WhatIfAnalysesPage),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../pilotage-analyses/opex-capex/opex-capex-analyses.page').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('../pilotage-analyses/groupe/groupe-analyses.page').then((m) => m.GroupeAnalysesPage),
