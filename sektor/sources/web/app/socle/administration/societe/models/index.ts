...
// @i18n-exempt — @deprecated Phase 1.2 — see ETABLISSEMENT_TYPE_KEYS in @app/socle/shell/i18n-labels.
...
// @i18n-exempt — @deprecated Phase 1.2 — see FORME_JURIDIQUE_KEYS in @app/socle/shell/i18n-labels.
