...
import { ButtonComponent, PageHeaderComponent, PageShellComponent, VilleMaSelectComponent } from '@platform/lib/anatomy';
...
@Component({
  ...
  imports: [FormsModule, TranslateModule, PageShellComponent, PageHeaderComponent, IceInputComponent, RibInputComponent, PhoneMaInputComponent, ButtonComponent, VilleMaSelectComponent],
  template: `
