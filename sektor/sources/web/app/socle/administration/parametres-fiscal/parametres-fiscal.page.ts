...
import { ButtonComponent, PageHeaderComponent, PageShellComponent, ToastService, buildRouteBreadcrumbs } from '@platform/lib/anatomy';
import { MoneyInputComponent } from '@platform/lib/anatomy/components/atoms/money-input/money-input.component';
