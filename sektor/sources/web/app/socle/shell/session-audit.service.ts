...
// @i18n-exempt — @deprecated Phase 1.2 — see FAILURE_REASON_KEYS in @app/socle/shell/i18n-labels.
...
// @i18n-exempt — @deprecated Phase 1.2 — see OUTCOME_KEYS in @app/socle/shell/i18n-labels.
