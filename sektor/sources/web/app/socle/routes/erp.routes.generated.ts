...
import { INVENTORY_BTP_ROUTES } from '../../catalogue/catalogue.routes';
...
export const ERP_ROUTES: Routes = [
  {
    ...
    loadChildren: () => import('../../finance/configuration/currencies/currency.routes').then(m => m.CURRENCY_ROUTES),
  },
  {
    path: 'inventory/mouvements/inventory-txes',
    loadChildren: () => import('../../catalogue/mouvements/inventory-txes/inventory-tx.routes').then(m => m.INVENTORY_TX_ROUTES),
  },
  {
    path: 'inventory/configuration/item-categories',
    loadChildren: () => import('../../catalogue/configuration/item-categories/item-category.routes').then(m => m.ITEM_CATEGORY_ROUTES),
  },
  {
    path: 'finance/configuration/exchange-rates',
    loadChildren: () => import('../../finance/configuration/exchange-rates/exchange-rate.routes').then(m => m.EXCHANGE_RATE_ROUTES),
  },
  {
    path: 'inventory/suivi/stock-balances',
    loadChildren: () => import('../../catalogue/suivi/stock-balances/stock-balance.routes').then(m => m.STOCK_BALANCE_ROUTES),
  },
  {
    path: 'inventory/units-of-measure',
    loadChildren: () => import('../../catalogue/configuration/unit-of-measures/unit-of-measure.routes').then(m => m.UNIT_OF_MEASURE_ROUTES),
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('../../catalogue/configuration/uo-mcategories/uo-mcategory.routes').then(m => m.UO_MCATEGORY_ROUTES),
  },
  {
    path: 'finance/configuration/payment-terms',
    loadChildren: () => import('../../finance/configuration/payment-terms/payment-term.routes').then(m => m.PAYMENT_TERM_ROUTES),
  },
  {
    path: 'chantiers/budget',
    loadChildren: () => import('../../chantiers/budget/budget-chantier.routes').then(m => m.BUDGET_CHANTIER_ROUTES),
  },
  {
    path: 'inventory/catalogue/item-prices',
    loadChildren: () => import('../../catalogue/item-prices/item-price.routes').then(m => m.ITEM_PRICE_ROUTES),
  },
  {
    path: 'inventory/mouvements/inventory-tx-lines',
    loadChildren: () => import('../../catalogue/mouvements/inventory-tx-lines/inventory-tx-line.routes').then(m => m.INVENTORY_TX_LINE_ROUTES),
  },
  ...CHANTIERS_ROUTES,
