...
import { DAY_KEYS_ORDERED } from '@app/socle/shell/i18n-labels';
...
@Component({
  ...
  imports: [FormsModule, TranslateModule, RouterLink, PageShellComponent, PageHeaderComponent, ButtonComponent],
  template: `
