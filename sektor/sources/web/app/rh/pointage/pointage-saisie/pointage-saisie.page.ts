...
import { PageHeaderComponent, PageShellComponent, TooltipDirective, ButtonComponent } from '@platform/lib/anatomy';
import type { Chantier } from '../../../chantiers/models';
import { ChantierApiService } from '../../../chantiers/services/chantier-api.service';
import { MODE_KEYS } from '@app/socle/shell/i18n-labels';
...
@Component({
  ...
  imports: [FormsModule, TranslateModule, PageShellComponent, PageHeaderComponent, TooltipDirective, ButtonComponent],
  template: `
