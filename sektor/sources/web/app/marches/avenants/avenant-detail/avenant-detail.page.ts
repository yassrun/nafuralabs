...
import { PageHeaderComponent, PageShellComponent, ConfirmDialogService } from '@platform/lib/anatomy';
...
import { AVENANT_STATUS_KEYS, AVENANT_TYPE_KEYS } from '@app/socle/shell/i18n-labels';
import {
  type Avenant,
  type AvenantStatus,
  type Marche,
} from '../../models';
import { ToastService } from '@platform/lib/anatomy/components/services/toast.service';
      ...
      @if (avenant(); as a) {
        ...
        <section class="approval-bar">
          ...
          <app-submit-approval-button
            ...
            [chantierId]="$safeNavigationMigration(marche()?.chantierId)"
            [chantierCode]="$safeNavigationMigration(marche()?.chantierCode)"
