...
/** Nature d'article — alignée sur l'enum back `ma.nafura.catalogue.domain.Nature`. */
export type Nature =
  | 'MATIERE'
  | 'CONSOMMABLE'
  | 'CARBURANT'
...
/** Lots d'usage chantier — enum back `ma.nafura.catalogue.domain.UsageLot` (multi par article). */
