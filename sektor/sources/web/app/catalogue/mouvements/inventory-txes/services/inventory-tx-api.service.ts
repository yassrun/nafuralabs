...
import { FeatureApiService, type ListResponse } from '@platform/lib/anatomy';
import type { InventoryTxWithLinesBody, InventoryTxWithLinesUpdateBody } from '@app/catalogue/services/inventory-tx-api.types';
import type { ApiInventoryTxDetail } from '@app/catalogue/services/inventory-tx.mapper';
