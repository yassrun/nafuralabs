...
import type { DetailActionEvent, DetailPageMode } from '@platform/lib/anatomy/types';
import type { InventoryTx } from '@app/catalogue/models';
import { PerteLinesEditorComponent } from '@app/catalogue/components/perte-lines-editor/perte-lines-editor.component';
