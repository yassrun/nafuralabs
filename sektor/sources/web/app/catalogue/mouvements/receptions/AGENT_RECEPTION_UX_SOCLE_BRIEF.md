...
Implémenter les améliorations UX prioritaires du flux Réceptions et les évolutions minimales du socle `@platform/lib/anatomy` nécessaires pour les supporter proprement, sans casser les autres pages.
