...
import { StockBalanceEnrichmentService } from '@app/catalogue/services/stock-balance-enrichment.service';
import type { StockBalance, LocationType } from '@app/catalogue/models';
import type {
