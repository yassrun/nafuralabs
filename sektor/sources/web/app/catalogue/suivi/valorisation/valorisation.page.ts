...
import type { DashboardPageConfig, DashboardDataProvider, KpiItem, ColumnConfig } from '@platform/lib/anatomy';
import { DataTableComponent, KpiStripComponent, BadgeComponent } from '@platform/lib/anatomy';
