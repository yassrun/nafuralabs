...
import { Component, ViewChild, inject, computed, signal, OnInit, ChangeDetectionStrategy } from '@angular/core';
...
import { LocationTypeBadgeComponent } from '../../components/location-type-badge';
import { QuantityStatusCellComponent } from '../../components/quantity-status-cell';
