...
import { ErpAttachmentUploadService } from '@app/socle/shared/services/erp-attachment-upload.service';
...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, TranslateModule, PageShellComponent, PageHeaderComponent, ButtonComponent, MadCurrencyPipe],
