...
import { ButtonComponent, PageHeaderComponent, PageShellComponent, ToastService } from '@platform/lib/anatomy/components';
...
import { PrintService } from '@app/socle/shared/services';
import type { Ecriture } from '@app/finance/models';
import { ECRITURE_STATUS_KEYS, ECRITURE_ORIGINE_KEYS } from '@app/socle/shell/i18n-labels';
...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, TranslateModule, PageShellComponent, PageHeaderComponent, ButtonComponent],
