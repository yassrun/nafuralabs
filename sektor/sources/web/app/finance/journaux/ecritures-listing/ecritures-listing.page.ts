...
import { ButtonComponent, PageHeaderComponent, PageShellComponent } from '@platform/lib/anatomy/components';
...
import { ECRITURE_ORIGINE_KEYS, ECRITURE_STATUS_KEYS } from '@app/socle/shell/i18n-labels';
