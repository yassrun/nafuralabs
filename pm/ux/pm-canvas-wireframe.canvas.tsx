...
const SEED: Task[] = [
  ...
  },
  {
    ...
    title: "UI PM Canvas (sans BDD / sans auth)",
    project: "ops",
  },
  {
    id: "ERP-03",
  ...
  const folder =
    task.project === "ops"
      ...
      : task.project === "personal"
        ? "pm/personal/tasks/"
        : "pm/nafura/products/sektor-btp/tasks/";
      ...
      <Button
        ...
        onClick={() =>
          dispatch({
            ...
            userPrompt: `Check progress PM : passe ${task.id} → ${task.status} (status déjà choisi dans le canvas PM) et append journal. Gate=${task.gate}. Si done → archive. Respecte pm/AGENTS.md.`,
          })
        }
      >
        Appliquer via agent
    ...
    <Button
      ...
      onClick={() =>
        dispatch({
          type: "newComposerChat",
          userPrompt:
            "Promote les lignes inbox.md vers tasks/ selon pm/AGENTS.md (kind/priority/assignee/gate), puis regen INDEX.",
        })
      }
    >
  ...
  return (
    <Button
      ...
      onClick={() =>
        dispatch({
          type: "newComposerChat",
          userPrompt: `Commit sprint : pose sprint: 2026-W33 sur ${id}, append journal, regen SPRINT.md (pm/AGENTS.md).`,
        })
      }
    >
      Via agent
    ...
    <Stack gap={20} style={{ padding: 20, maxWidth: 980 }}>
      <Stack gap={6}>
        ...
        <Text tone="secondary" size="small">
          Sans BDD · sans auth · snapshot fichiers pm/ · OPS-02
        </Text>
      </Stack>
      ...
      <Text tone="tertiary" size="small">
        SSOT Git : pm/ux/pm-canvas-wireframe.canvas.tsx · Preview : canvases/
      </Text>
    </Stack>
  );
}
