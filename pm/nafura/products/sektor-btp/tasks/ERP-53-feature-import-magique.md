...
assignee: me
gate: me
feature: import-magique
tags: [sektor, platform, import, extraction, ia]
---

# Feature — Import magique (moteur d'extraction unifié)
...
> Epic : `products/sektor-btp/docs/specs/epics/import-magique/`
...
```
11/08  spec · epic import-magique créé (00-PLAN + 00-ARCHITECTURE + 00-PROGRESS)
```
