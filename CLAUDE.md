...
3. [`pm/AGENTS.md`](pm/AGENTS.md) — backlog / sprint / bugs (§2.2)
...
| Rule | Contenu |
|------|---------|
| `.cursor/rules/specs-epics.mdc` | Specs → `docs/specs/epics/<slug>/` ; canvas SSOT → `epics/<slug>/ux/` ; bugs → `pm/` |
...
| Tickets / bugs | `pm/…/tasks/` — jamais dans docs epic |
...
- Travail Nafura hors ticket `pm/` + `sprint:` (voir `pm/AGENTS.md`)
